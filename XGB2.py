...
##### unbalanced train feat #####
label_encoder = preprocessing.LabelEncoder()
encoded_day2 = label_encoder.fit_transform(df["Checkout Day of Week"])
encoded_cstation2 = label_encoder.fit_transform(df["Checkout Station"])
encoded_rstation2 = label_encoder.fit_transform(df["Return Station (Station Information)"])
comhrs2 = df['pm_commute_hrs']
acomhrs2 = df['am_commute_hrs']
chour2 = df['Checkout hour']
wknd2 = df['weekend']
gains2 = df['net_gain']
dist2 = df['o_d_dist']
...
##end###
train_features2 = pd.DataFrame([encoded_cstation2,
                              encoded_rstation2,
                              encoded_day2,
                              comhrs2,
                              chour2,
...
X_train2, X_test2, y_train2, y_test2 = train_test_split(train_features2, df['Overcharge'], test_size=0.4, random_state=0)
...
model
predcs = model.predict(X_test2)
pd.crosstab(predcs,y_test2)
